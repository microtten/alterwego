...
const Content = function(){
    ...
    <div className="content">
      ...
      <ul className="fright link">
        <li className="fleft padr10">
          <a href="#">Documents</a>
        </li>
        <li className="fright">
          <a href="#">Historique des echanges</a>
        </li>
      </ul>
        ...
        <form>
          <div className="form-info bs pad13 check">
            <div className="form1 statut tb-cell">
              <label className="form-check-label display vm" htmlFor="statut">
                Statut :
              </label>
              <input
                type="checkbox"
            ...
            <div className="form1 abandon tb-cell">
              <label className="form-check-label display vm" htmlFor="abandon">
                Abandon :
              </label>
              <input
                type="checkbox"
            ...
            <div className="form1 tb-cell">
              <label className="form3-label display vm" htmlFor="paie">
                Paie les loyers :
              </label>
              <input
                type="checkbox"
            ...
            <div className="form1 tb-cell">
              <label className="form-check-label display vm" htmlFor="offre">
                Offre Assureurs :{" "}
              </label>
              <input
                type="checkbox"
          ...
          <div className="form-info pad13 bs not-bs">
            ...
            <div className="field">
              ...
              <input
                type="text"
                className="noborder bs email-field"
                name=""
                placeholder=""
              />
            </div>
          ...
          <div className="form-info bs pad13 not-bs">
            ...
            <div className="info-in2">
              <div className="info-bq-detail">
                <label htmlFor="banque">Situation assurance</label>
                <br />
                <select
                  className="noborder opt bs"
                  id="banque"
                  name="banque"
                  ref={register()}
                >
          ...
          <div className="not-bs save">
            <button className="btnlast btn btn-default">
              <i className="fa fa-edit"></i>Sauvegarder
            </button>
          </div>
          <ListUploadDoc />
          <div className="histo">
